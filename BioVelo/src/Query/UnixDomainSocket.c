...
#include <jni.h>
#include "Query_UnixDomainSocket.h"
...
JNIEXPORT jint JNICALL Java_Query_UnixDomainSocket_nativeOpen(JNIEnv *jEnv, jclass jClass, jstring jSocketFile)
{
...
JNIEXPORT jint JNICALL Java_Query_UnixDomainSocket_nativeRead(JNIEnv *jEnv, jclass jClass, jint jSocketFileHandle)
{
...
JNIEXPORT jint JNICALL Java_Query_UnixDomainSocket_nativeWrite(JNIEnv *jEnv, jclass jClass, jint jSocketFileHandle, jint jData)
{
...
JNIEXPORT void JNICALL Java_Query_UnixDomainSocket_nativeClose(JNIEnv *jEnv, jclass jClass, jint jSocketFileHandle)
{
        /* Close the socket */
	close(jSocketFileHandle);
}

JNIEXPORT void JNICALL Java_Query_UnixDomainSocket_nativeCloseInput(JNIEnv *jEnv, jclass jClass, jint jSocketFileHandle)
{
        /* Close the socket input stream */
	shutdown(jSocketFileHandle, SHUT_RD);
}

JNIEXPORT void JNICALL Java_Query_UnixDomainSocket_nativeCloseOutput(JNIEnv *jEnv, jclass jClass, jint jSocketFileHandle)
{
