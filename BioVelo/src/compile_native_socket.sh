...
gcc -I/usr/lib/jvm/java-6-openjdk-amd64/include -I/usr/lib/jvm/java-6-openjdk-amd64/include/linux/ -I. edu/iastate/javacyco/edu_iastate_javacyco_UnixDomainSocket.c -o libunixdomainsocket.so -shared -fPIC
